...
// All icons use consistent Unicode geometric/astrological symbols — no emoji
const NAV_SECTIONS = [
  ...
  { type: 'item', icon: '𓂀', label: 'Egyptian', id: 'egyptian', widget: 'egyptian' },

  { type: 'section', label: 'SACRED MATHEMATICS' },
  { type: 'item', icon: '∞', label: 'Numerology', id: 'num', widget: 'num' },
  { type: 'item', icon: 'א', label: 'Gematria', id: 'gem', widget: 'gem' },

  { type: 'section', label: 'EASTERN WISDOM' },
  { type: 'item', icon: 'ॐ', label: 'Vedic', id: 'vedic', widget: 'vedic' },
